...
from src.engine.horary import check_translation_of_light, check_collection_of_light
from src.engine.medical import MedicalAstrology as MedicalEngine
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "city": {
                    "type": "string",
                    "description": "Birth city (e.g., 'Fairfield')",
                },
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "include_forecast": {
                    "type": "boolean",
                    "description": "Include 5-year forecast",
                    "default": True,
                },
            },
            "required": ["year", "month", "day", "hour", "minute", "city"],
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "hours_to_scan": {
                    "type": "integer",
                    "description": "Hours to scan ahead",
                    "default": 168,
                },
                "start_date": {
                    "type": "string",
                    "description": "Start date (YYYY-MM-DD), defaults to now",
                },
            },
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "target_date": {
                    "type": "string",
                    "description": "Date to check (YYYY-MM-DD), defaults to now",
                },
            },
            "required": ["year", "month", "day", "hour", "minute", "city"],
        },
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "city": {
                    "type": "string",
                    "description": "Location where question is asked",
                },
                "state": {"type": "string", "description": "State/region"},
                "question_time": {
                    "type": "string",
                    "description": "Time question was asked (YYYY-MM-DD HH:MM), defaults to now",
                },
            },
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "return_year": {
                    "type": "integer",
                    "description": "Year of solar return",
                },
                "return_city": {
                    "type": "string",
                    "description": "Location for solar return (defaults to birth city)",
                },
                "return_state": {
                    "type": "string",
                    "description": "State for solar return",
                },
            },
            "required": [
                "birth_year",
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "time": {
                    "type": "string",
                    "description": "Time to check (YYYY-MM-DD HH:MM), defaults to now",
                },
            },
            "required": ["city"],
        },
...
async def handle_calculate_chart(args: dict) -> dict:
    ...
    return {
        "birth_data": {"datetime": dt.isoformat(), "location": f"{city}, {state}"},
        "planets": [
            {
                "name": p.name.value,
...
async def handle_forensic_audit(args: dict) -> dict:
    ...
    # Format dt to strings
    date_str = f"{args['year']:04d}-{args['month']:02d}-{args['day']:02d}"
...
async def handle_decennials(args: dict) -> dict:
    ...
    result = engine.generate_decennials(chart, dt)
...
async def handle_phasis(args: dict) -> dict:
    ...
    for planet in chart.planets:
        if planet.name in [
            ...
            visibility = PhasisEngine.calculate_visibility_details(
                chart.jd,  # type: ignore
            ...
            phase = PhasisEngine.get_synodic_phase(planet, sun.longitude)
            results[planet.name.value] = {
                "visibility": visibility,
                "synodic_phase": phase.value if hasattr(phase, "value") else str(phase),
            }
...
async def handle_medical(args: dict) -> dict:
    ...
    result = engine.analyze(chart)  # type: ignore
...
async def handle_horary(args: dict) -> dict:
    ...
    engine = HoraryEngine()  # type: ignore
    result = engine.judge(
        question=question, question_dt=question_dt, city=city, state=state
    )
...
async def handle_synastry(args: dict) -> dict:
    ...
    result = engine.analyze_structural_fit(chart1, chart2)
...
async def handle_planetary_hour(args: dict) -> dict:
    ...
    calc = PlanetaryHourEngine()
    result = calc.calculate_hours(dt, lat, lon)
