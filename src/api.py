...
async def capture_email(req: EmailCaptureRequest):
    """
    Captures email, generates the formatted reading PDF, and sends it to the user.
    """
    if not req.email or "@" not in req.email:
        raise HTTPException(status_code=400, detail="Invalid email address.")

    # 1. Re-calculate chart to ensure integrity/security (don't trust frontend JSON fully)
    ...
    try:
        ...
        if tier == "free":
            ...
            <body style="font-family: serif; color: #1a1a1a; max-width: 600px; margin: 0 auto; padding: 20px;">
                ...
                <p><em>In Fellowship,<br>The Codex Caelestis Team</em></p>
            </body>
            </html>
            """
        else:
            ...
            <body style="font-family: serif; color: #1a1a1a; max-width: 600px; margin: 0 auto; padding: 20px;">
                ...
                <p>This document contains the full analysis of your nativity, including all prediction modules and medical checks.</p>
                <p>Thank you for supporting traditional astrology research.</p>
                <p><em>In Fellowship,<br>The Codex Caelestis Team</em></p>
            </body>
            </html>
            """
        ...
        if not success:
            # Log error but don't fail client if possible? 
            # Client expects success to show "Check your email"
