...
def test_group_into_windows_single():
    engine = ElectionalEngine()
    slots = [{"time": "2026-03-22T10:00:00", "score": 30, "mood": "Favorable", "details": ["A"]}]
...
def test_group_into_windows_contiguous():
    engine = ElectionalEngine()
    slots = [
        {"time": "2026-03-22T10:00:00", "score": 20, "mood": "Average", "details": ["A"]},
        {"time": "2026-03-22T11:00:00", "score": 40, "mood": "Favorable", "details": ["B"]},
        {"time": "2026-03-22T12:00:00", "score": 30, "mood": "Average", "details": ["C"]},
    ]
    windows = engine._group_into_windows(slots)
    assert len(windows) == 1
...
def test_group_into_windows_gap():
    ...
    slots = [
        {"time": "2026-03-22T10:00:00", "score": 20, "mood": "Average", "details": ["A"]},
        {"time": "2026-03-22T14:00:00", "score": 50, "mood": "Excellent (Kairos)", "details": ["B"]},
    ]
    windows = engine._group_into_windows(slots)
