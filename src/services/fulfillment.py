...
class FulfillmentService:
    ...
    async def fulfill_order(
        user_email: str, user_name: str, chart_request: dict, tier: str = "onetime"
    ):
        """
        ...
        try:
            ...
            pdf_tier = (
                "FULL"  # Default to FULL for standard flow, unless specified otherwise
            )
            ...
            pdf_buffer = await run_in_threadpool(
                generator.generate, custom_content=custom_markdown  # type: ignore
            )
