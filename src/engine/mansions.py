...
class LunarMansionEngine:
    ...
    MANSIONS = [
      ...
      },
      {
        ...
        "intents_bad": [
          "marriage",
          "travel (especially dangerous journeys)"
        ],
        "source_refs": [
          "Picatrix Bk I, Ch 4",
          "Medieval Astrology Guide"
      ...
      },
      {
        ...
        "intents_bad": [
          "destruction and prostration of captives"
        ],
        "source_refs": [
          "Picatrix Bk I, Ch 4"
        ]
    ...
    def get_lunar_mansion(longitude_deg: float, include_boundary: bool = True) -> Dict:
        ...
        if include_boundary:
            ...
            mansion_index = int((norm_lon + 0.000000001) // LunarMansionEngine.MANSION_WIDTH)
        
        # Handle edge case at 360/0
        if mansion_index == 28:
            mansion_index = 0 # Wrap to start if it hit exactly 360, but wait.. 360 is 0.
            # Actually the index goes 0..27.
            # If norm_lon is 359.999, index is 27.
            # If norm_lon is 0.0, index is 0.
        
        # Safety clamp
        if mansion_index > 27: mansion_index = 0
        if mansion_index < 0: mansion_index = 0
