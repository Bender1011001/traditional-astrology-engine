...
def run_premium_report(chart_data, output_file, iterations=6):
    ...
    print(f"\n{'='*80}")
    print(f"PREMIUM REPORT GENERATION - AstroForge")
...
---
**Generated by AstroForge | traditional-astrology.com**
*Timestamp: {timestamp}*
...
"""
    ...
    final_report += "This report is rendered by the AstroForge engine using rules from the Hellenistic and Medieval corpora. These results are for historical and spiritual research purposes only. Accuracy depends on precise birth data.\n\n"
    final_report += "© 2026 AstroForge | [traditional-astrology.com](https://traditional-astrology.com)\n"
