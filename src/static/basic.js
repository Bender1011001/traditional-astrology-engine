...
window.shareReading = async function () {
    ...
    card.innerHTML = `
        <div style="font-size: 40px; text-transform: uppercase; letter-spacing: 0.2em; color: #888; margin-bottom: 40px;">AstroForge</div>
        ...
        const canvas = await html2canvas(target, {
            ...
            onclone: (doc) => {
                ...
                if (node) {
                    ...
                    watermark.innerHTML = "GENERATED BY <strong>AstroForge</strong>";
