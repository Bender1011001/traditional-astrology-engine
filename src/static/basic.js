...
window.shareReading = async function () {
    ...
    card.innerHTML = `
        <div style="font-size: 40px; text-transform: uppercase; letter-spacing: 0.2em; color: #888; margin-bottom: 40px;">Traditional Astrology</div>
        ...
        <div style="font-size: 50px; color: #d4af37;">NATAL CHART READING</div>
                ...
                try {
                    ...
                    fortuneContainer.innerHTML = `
                        <div class="basic-card highlight-border" style="margin-top: 2rem;">
                            ...
                            <div class="seo-upsell">
                                <p>Knowing the Lot is step 1. Knowing its Ruler's condition is step 2.</p>
                                <button class="btn-primary full-width" onclick="window.location.href='/'">UNLOCK FULL READING</button>
                            </div>
                            `}
                ...
                try {
                    ...
                    hylegContainer.innerHTML = `
                        <div class="basic-card highlight-border" style="margin-top: 2rem;">
                            ...
                            ${promoUnlocked ? "" : `
                            <div class="seo-upsell">
                                <p>See the full breakdown of your traditional constitution and temperament.</p>
                                <button class="btn-primary full-width" onclick="window.location.href='/'">UNLOCK FULL REPORT</button>
                            </div>
                            `}
...
window.shareReading = async function () {
    ...
    try {
        ...
        const canvas = await html2canvas(target, {
            ...
            onclone: (doc) => {
                ...
                if (node) {
                    ...
                    watermark.innerHTML = "GENERATED BY <strong>Traditional Astrology</strong>";
        ...
        const file = new File([imageBlob], "my-natal-chart-reading.png", { type: "image/png" });

        if (navigator.canShare && navigator.canShare({ files: [file] })) {
            await navigator.share({
                title: 'My Traditional Astrology Reading',
                text: 'My natal chart reading from Traditional Astrology. Real planetary calculations, not AI guesswork.',
                files: [file]
            });
        } else {
            // Fallback: Download
            const link = document.createElement('a');
            link.download = 'natal-chart-reading.png';
...
const GLOSSARY_TERMS = {
    ...
    "hyleg": "The Giver of Life; a planet or point used in traditional texts as vitality symbolism, not medical advice.",
    "alcocoden": "The Giver of Years; the planet associated with the Hyleg in historical doctrine. This site does not predict lifespan.",
