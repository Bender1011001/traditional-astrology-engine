...
def main():
    ...
    city = "Fairfield"
    state = "CA"
    subject_name = "User" # Contextual

    json_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../specific_reading_output.json'))
    pdf_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../specific_reading_report.pdf'))
